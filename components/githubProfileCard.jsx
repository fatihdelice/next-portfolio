    ...
    <div className="profileCard">
      ...
      <div className="z-1 relative">
        ...
        <Link href={url}>
          ...
          <p className="bg-red-500 text-white hover:scale-[1.02] hover:shadow-md hover:shadow-red-100/30 transition-all text-center p-3 mt-4 rounded-xl dark:bg-red-500 dark:text-white">
